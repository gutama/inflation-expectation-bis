    ...
    def predict_inflation_expectation(self, message: str) -> Dict:
        ...
        try:
            ...
            response = completion(
                ...
                temperature=0.7 # todo: tweak this
            )
...
class ExperimentManager:
    ...
    def generate_treatments(self) -> Dict[str, str]:
        ...
        treatments = {
            ...
            """,
            'media_narrative': f"""
                This is a summary of recent news in Indonesia and worldwide:
            ...
            'full_policy_context': f"""
                ...
                - IDR/USD exchange rate: {context['rupiah_exchange_rate']}
            """
        }
...
class DataAnalyzer:
    ...
    def run_regression_analysis(self) -> Dict:
        ...
        treatment_dummy_names = [
            'treatment_current_inflation',
            'treatment_inflation_target',
